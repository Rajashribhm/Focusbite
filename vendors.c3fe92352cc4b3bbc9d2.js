/*!For license information please see vendors.c3fe92352cc4b3bbc9d2.js.LICENSE.txt*/
"use strict";
(self.webpackChunkgf_pomodoro = self.webpackChunkgf_pomodoro || []).push([[216], {
    169: (t, e, i) => {
        i.d(e, {
            u_: () => Ri,
            OK: () => Dn,
            ...
            fn: function(t) {
                ...
                Object.keys(e.elements).forEach((function(t) {
                    var i = e.styles[t] || {}
                      , n = e.attributes[t] || {}
                      , s = e.elements[t];
                    D(s) && k(s) && (Object.assign(s.style, i),
            ...
            effect: function(t) {
                ...
                function() {
                    Object.keys(e.elements).forEach((function(t) {
                        ...
                        D(n) && k(n) && (Object.assign(n.style, o),
        ...
        function V(t) {
            for (var e = L(t), i = U(t); i && q(i) && "static" === $(i).position; )
                i = U(i);
            return i && ("html" === k(i) || "body" === k(i) && "static" === $(i).position) ? e : i || function(t) {
                var e = -1 !== navigator.userAgent.toLowerCase().indexOf("firefox");
                if (-1 !== navigator.userAgent.indexOf("Trident") && D(t) && "fixed" === $(t).position)
                    return null;
                var i = F(t);
        ...
        const G = {
            ...
            phase: "main",
            fn: function(t) {
                var e, i = t.state, n = t.name, l = t.options, h = i.elements.arrow, d = i.modifiersData.popperOffsets, u = P(i.placement), f = K(u), p = [a, r].indexOf(u) >= 0 ? "height" : "width";
                if (h && d) {
                    var m = function(t, e) {
        ...
        function tt(t) {
            var e, i = t.popper, n = t.popperRect, l = t.placement, c = t.variation, h = t.offsets, u = t.position, f = t.gpuAcceleration, p = t.adaptive, m = t.roundOffsets, g = t.isFixed, _ = h.x, b = void 0 === _ ? 0 : _, v = h.y, y = void 0 === v ? 0 : v, w = "function" == typeof m ? m({
                x: b,
                y
            }) : {
                x: b,
            ...
            if (p) {
                var x = V(i)
                  , k = "clientHeight"
                  , S = "clientWidth";
                x === L(i) && "static" !== $(x = z(i)).position && "absolute" === u && (k = "scrollHeight",
                S = "scrollWidth"),
                (l === s || (l === a || l === r) && c === d) && (O = o,
                y -= (g && x === C && C.visualViewport ? C.visualViewport.height : x[k]) - n.height,
                y *= f ? 1 : -1),
                l !== a && (l !== s && l !== o || c !== d) || (T = r,
                b -= (g && x === C && C.visualViewport ? C.visualViewport.width : x[S]) - n.width,
                b *= f ? 1 : -1)
            }
            var D, N = Object.assign({
                position: u
            }, p && Z), I = !0 === m ? function(t) {
                var e = t.x
                  , i = t.y
            ...
            return b = I.x,
            y = I.y,
            f ? Object.assign({}, N, ((D = {})[O] = A ? "0" : "",
            D[T] = E ? "0" : "",
            D.transform = (C.devicePixelRatio || 1) <= 1 ? "translate(" + b + "px, " + y + "px)" : "translate3d(" + b + "px, " + y + "px, 0)",
            D)) : Object.assign({}, N, ((e = {})[O] = A ? y + "px" : "",
            e[T] = E ? b + "px" : "",
            e.transform = "",
            e))
        }
        ...
        function pt(t, e) {
            return e === f ? ft(function(t) {
                ...
                var e, i = z(t), n = lt(t), s = null == (e = t.ownerDocument) ? void 0 : e.body, o = M(i.scrollWidth, i.clientWidth, s ? s.scrollWidth : 0, s ? s.clientWidth : 0), r = M(i.scrollHeight, i.clientHeight, s ? s.scrollHeight : 0, s ? s.clientHeight : 0), a = -n.scrollLeft + ct(t), l = -n.scrollTop;
        ...
        function mt(t) {
            var e, i = t.reference, n = t.element, l = t.placement, c = l ? P(l) : null, u = l ? J(l) : null, f = i.x + i.width / 2 - n.width / 2, p = i.y + i.height / 2 - n.height / 2;
            switch (c) {
            case s:
                e = {
                    x: f,
        ...
        const yt = {
          ...
          , At = {
            ...
            fn: function(t) {
                ...
                if (x) {
                    if (c) {
                        var H, B = "y" === O ? s : a, W = "y" === O ? o : r, $ = "y" === O ? "height" : "width", q = x[O], z = q + w[B], F = q - w[W], U = b ? -L[$] / 2 : 0, Y = A === h ? k[$] : L[$], Q = A === h ? -L[$] : -k[$], G = e.elements.arrow, Z = b && G ? R(G) : {
                            width: 0,
                            height: 0
                            ...
                            bottom: 0,
                            left: 0
                        }, et = tt[B], it = tt[W], nt = X(0, k[$], Z[$]), st = T ? k[$] / 2 - U - nt - et - D.mainAxis : Y - nt - et - D.mainAxis, ot = T ? -k[$] / 2 + U + nt + it + D.mainAxis : Q + nt + it + D.mainAxis, rt = e.elements.arrow && V(e.elements.arrow), at = rt ? "y" === O ? rt.clientTop || 0 : rt.clientLeft || 0 : 0, lt = null != (H = null == N ? void 0 : N[O]) ? H : 0, ct = q + ot - lt, ht = X(b ? j(z, q + st - lt - at) : z, q, b ? M(F, ct) : F);
                        x[O] = ht,
                        I[O] = ht - q
                    }
                    if (u) {
                        var dt, ut = "x" === O ? s : a, ft = "x" === O ? o : r, pt = x[C], mt = "y" === C ? "height" : "width", _t = pt + w[ut], bt = pt - w[ft], vt = -1 !== [s, a].indexOf(E), yt = null != (dt = null == N ? void 0 : N[C]) ? dt : 0, wt = vt ? _t : pt - k[mt] - L[mt] - yt + D.altAxis, Et = vt ? pt + k[mt] + L[mt] - yt - D.altAxis : bt, At = b && vt ? function(t, e, i) {
                            var n = X(t, e, i);
                            return n > i ? i : n
        ...
        function Tt(t, e, i) {
            void 0 === i && (i = !1);
            var n, s, o = D(e), r = D(e) && function(t) {
            ...
            D(e) ? ((h = B(e, !0)).x += e.clientLeft,
            h.y += e.clientTop) : a && (h.x = ct(a))),
            {
        ...
        const Nt = "transitionend"
          ...
          , Ht = t => !(!t || "object" != typeof t) && (void 0 !== t.jquery && (t = t[0]),
        void 0 !== t.nodeType)
        ...
        const fe = {
          ...
          , me = {
            ...
            remove(t, e) {
                ...
                const i = pe.get(t);
                i.delete(e),
                0 === i.size && pe.delete(t)
            }
        };
        class ge {
            constructor(t) {
                (t = Bt(t)) && (this._element = t,
        ...
        class je extends ge {
            ...
            pause(t) {
                t || (this._isPaused = !0),
                Te.findOne(".carousel-item-next, .carousel-item-prev", this._element) && (jt(this._element),
                this.cycle(!0)),
            ...
            to(t) {
                ...
                if (t > this._items.length - 1 || t < 0)
                    return;
                if (this._isSliding)
                    return void fe.one(this._element, Ie, ( () => this.to(t)));
                if (e === t)
                    return this.pause(),
                    void this.cycle();
                const i = t > e ? ke : Le;
            ...
            _handleSwipe() {
                ...
                this.touchDeltaX = 0,
                e && this._slide(e > 0 ? De : Se)
            }
            _addEventListeners() {
                this._config.keyboard && fe.on(this._element, "keydown.bs.carousel", (t => this._keydown(t))),
                "hover" === this._config.pause && (fe.on(this._element, "mouseenter.bs.carousel", (t => this.pause(t))),
                fe.on(this._element, "mouseleave.bs.carousel", (t => this.cycle(t)))),
            ...
            _addTouchEventListeners() {
                ...
                this._pointerEvent ? (fe.on(this._element, "pointerdown.bs.carousel", (t => e(t))),
                fe.on(this._element, "pointerup.bs.carousel", (t => n(t))),
                this._element.classList.add("pointer-event")) : (fe.on(this._element, "touchstart.bs.carousel", (t => e(t))),
                fe.on(this._element, "touchmove.bs.carousel", (t => i(t))),
            ...
            _getItemIndex(t) {
                return this._items = t && t.parentNode ? Te.find(".carousel-item", t.parentNode) : [],
            ...
            static dataApiClickHandler(t) {
                ...
                n && je.getInstance(e).to(n),
                t.preventDefault()
            }
        }
        fe.on(document, "click.bs.carousel.data-api", "[data-bs-slide], [data-bs-slide-to]", je.dataApiClickHandler),
        ...
        class ui extends ge {
            ...
            show() {
                if ($t(this._element) || this._isShown(this._menu))
                    return;
                const t = {
                ...
                "ontouchstart"in document.documentElement && !e.closest(".navbar-nav") && [].concat(...document.body.children).forEach((t => fe.on(t, "mouseover", zt))),
                this._element.focus(),
            ...
            _completeHide(t) {
                fe.trigger(this._element, "hide.bs.dropdown", t).defaultPrevented || ("ontouchstart"in document.documentElement && [].concat(...document.body.children).forEach((t => fe.off(t, "mouseover", zt))),
                this._popper && this._popper.destroy(),
            ...
            _getConfig(t) {
                ...
                Rt(Ke, t, this.constructor.DefaultType),
                "object" == typeof t.reference && !Ht(t.reference) && "function" != typeof t.reference.getBoundingClientRect)
            ...
            _createPopper(t) {
                ...
                s && Ae.setDataAttribute(this._menu, "popper", "static")
            }
            _isShown(t=this._element) {
            ...
            static dataApiKeydownHandler(t) {
                if (/input|textarea/i.test(t.target.tagName) ? t.key === Ye || t.key !== Xe && (t.key !== Ge && t.key !== Qe || t.target.closest(ni)) : !Je.test(t.key))
                    return;
                ...
                if (t.key !== Xe)
                    return t.key === Qe || t.key === Ge ? (e || n.show(),
                    void n._selectMenuItem(t)) : void (e && t.key !== Ye || ui.clearMenus());
                n.hide()
            }
        }
        fe.on(document, ti, ii, ui.dataApiKeydownHandler),
        fe.on(document, ti, ni, ui.dataApiKeydownHandler),
        fe.on(document, Ze, ui.clearMenus),
        fe.on(document, "keyup.bs.dropdown.data-api", ui.clearMenus),
        fe.on(document, Ze, ii, (function(t) {
            t.preventDefault(),
        ...
        class mi {
            ...
            _resetElementAttributes(t, e) {
                this._applyManipulationCallback(t, (t => {
                    ...
                    void 0 === i ? t.style.removeProperty(e) : (Ae.removeDataAttribute(t, e),
                    t.style[e] = i)
                }
                ))
            }
        ...
        class yi {
            ...
            dispose() {
                this._isAppended && (fe.off(this._element, vi),
                this._element.remove(),
                this._isAppended = !1)
            }
            _emulateAnimation(t) {
        ...
        class Ri extends ge {
            ...
            hide() {
                ...
                fe.off(this._element, Ii),
                fe.off(this._dialog, Mi),
                this._queueCallback(( () => this._hideModal()), this._element, t)
            }
            dispose() {
                [window, this._dialog].forEach((t => fe.off(t, ".bs.modal"))),
            ...
            _triggerBackdropTransition() {
                ...
                !n && "hidden" === i.overflowY || t.contains(Bi) || (n || (i.overflowY = "hidden"),
                t.add(Bi),
                this._queueCallback(( () => {
                    t.remove(Bi),
        ...
        class Vi extends ge {
            ...
            hide() {
                this._isShown && (fe.trigger(this._element, "hide.bs.offcanvas").defaultPrevented || (this._focustrap.deactivate(),
                this._element.blur(),
                this._isShown = !1,
        ...
        fe.on(window, "load.bs.offcanvas.data-api", ( () => Te.find(Fi).forEach((t => Vi.getOrCreateInstance(t).show())))),
        _e(Vi),
        Xt(Vi);
        const Ki = new Set(["background", "cite", "href", "itemtype", "longdesc", "poster", "src", "xlink:href"])
          ...
          , Qi = (t, e) => {
            ...
            if (e.includes(i))
                return !Ki.has(i) || Boolean(Xi.test(t.nodeValue) || Yi.test(t.nodeValue));
        ...
        class pn extends ge {
            ...
            toggle(t) {
                if (this._isEnabled)
                    if (t) {
                        ...
                        if (this.getTipElement().classList.contains(rn))
            ...
            dispose() {
                ...
                fe.off(this._element.closest(hn), dn, this._hideModalHandler),
            ...
            show() {
                ...
                if (t.defaultPrevented || !i)
                    return;
                "tooltip" === this.constructor.NAME && this.tip && this.getTitle() !== this.tip.querySelector(cn).innerHTML && (this._disposePopper(),
                this.tip.remove(),
                this.tip = null);
                ...
                this._config.animation && n.classList.add(on);
                const o = "function" == typeof this._config.placement ? this._config.placement.call(this, n, this._element) : this._config.placement
                  , r = this._getAttachment(o);
                this._addAttachmentClass(r);
                const {container: a} = this._config;
                me.set(n, this.constructor.DATA_KEY, this),
                ...
                this._popper ? this._popper.update() : this._popper = St(this._element, n, this._getPopperConfig(r)),
                n.classList.add(rn);
            ...
            hide() {
                ...
                "ontouchstart"in document.documentElement && [].concat(...document.body.children).forEach((t => fe.off(t, "mouseover", zt))),
                this._activeTrigger.click = !1,
                this._activeTrigger.focus = !1,
                this._activeTrigger.hover = !1;
                const e = this.tip.classList.contains(on);
                this._queueCallback(( () => {
                    this._isWithActiveTrigger() || (this._hoverState !== an && t.remove(),
                    this._cleanTipClass(),
            ...
            setElementContent(t, e) {
                if (null !== t)
                    ...
                    t.append(e)) : t.textContent = e.textContent)) : void (this._config.html ? (this._config.sanitize && (e = Gi(e, this._config.allowList, this._config.sanitizeFn)),
            ...
            _setListeners() {
                this._config.trigger.split(" ").forEach((t => {
                    if ("click" === t)
                        fe.on(this._element, this.constructor.Event.CLICK, this._config.selector, (t => this.toggle(t)));
                    else if ("manual" !== t) {
                        ...
                        fe.on(this._element, e, this._config.selector, (t => this._enter(t))),
                        fe.on(this._element, i, this._config.selector, (t => this._leave(t)))
                    }
                }
                )),
                ...
                ,
                fe.on(this._element.closest(hn), dn, this._hideModalHandler),
            ...
            _enter(t, e) {
                ...
                t && (e._activeTrigger["focusin" === t.type ? fn : un] = !0),
                e.getTipElement().classList.contains(rn) || e._hoverState === an ? e._hoverState = an : (clearTimeout(e._timeout),
                e._hoverState = an,
            ...
            _leave(t, e) {
                e = this._initializeOnDelegatedTarget(t, e),
                t && (e._activeTrigger["focusout" === t.type ? fn : un] = e._element.contains(t.relatedTarget)),
            ...
            _getConfig(t) {
                ...
                (t = {
                    ...
                    ...e,
                    ..."object" == typeof t && t ? t : {}
                }).container = !1 === t.container ? document.body : Bt(t.container),
                ...
                Rt(Ji, t, this.constructor.DefaultType),
                t.sanitize && (t.template = Gi(t.template, t.allowList, t.sanitizeFn)),
                t
            }
            _getDelegateConfig() {
                const t = {};
        ...
        class On extends ge {
            constructor(t, e) {
                ...
                fe.on(this._scrollElement, "scroll.bs.scrollspy", ( () => this._process())),
                this.refresh(),
                this._process()
            }
            static get Default() {
            ...
            refresh() {
                ...
                Te.find(An, this._config.target).map((t => {
                    const n = Pt(t)
                      , s = n ? Te.findOne(n) : null;
                    if (s) {
                        const t = s.getBoundingClientRect();
                        if (t.width || t.height)
                            return [Ae[e](s).top + i, n]
                    }
                    return null
                }
            ...
            dispose() {
                fe.off(this._scrollElement, ".bs.scrollspy"),
                super.dispose()
            }
            _getConfig(t) {
                return (t = {
            ...
            _activate(t) {
                ...
                i.classList.add(En),
                i.classList.contains("dropdown-item") ? Te.findOne(".dropdown-toggle", i.closest(".dropdown")).classList.add(En) : Te.parents(i, ".nav, .list-group").forEach((t => {
                    Te.prev(t, ".nav-link, .list-group-item").forEach((t => t.classList.add(En))),
        ...
        class Dn extends ge {
            ...
            show() {
                if (this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && this._element.classList.contains(Cn))
                    return;
                let t;
            ...
            _transitionComplete(t, e, i) {
                ...
                Ft(t),
                t.classList.contains(xn) && t.classList.add(kn);
                let n = t.parentNode;
                if (n && "LI" === n.nodeName && (n = n.parentNode),
                n && n.classList.contains("dropdown-menu")) {
                    const e = t.closest(".dropdown");
                    e && Te.find(".dropdown-toggle", e).forEach((t => t.classList.add(Cn))),
        ...
        fe.on(document, "click.bs.tab.data-api", '[data-bs-toggle="tab"], [data-bs-toggle="pill"], [data-bs-toggle="list"]', (function(t) {
            ["A", "AREA"].includes(this.tagName) && t.preventDefault(),
            $t(this) || Dn.getOrCreateInstance(this).show()
        }
        )),
        Xt(Dn);
        const Nn = "toast"
        ...
        class Bn extends ge {
            ...
            show() {
                fe.trigger(this._element, "show.bs.toast").defaultPrevented || (this._clearTimeout(),
            ...
            hide() {
                this._element.classList.contains(Pn) && (fe.trigger(this._element, "hide.bs.toast").defaultPrevented || (this._element.classList.add(Mn),
                this._queueCallback(( () => {
            ...
            dispose() {
                this._clearTimeout(),
                this._element.classList.contains(Pn) && this._element.classList.remove(Pn),
                super.dispose()
            }
            _getConfig(t) {
                return t = {
                ...
                Rt(Nn, t, this.constructor.DefaultType),
                t
            }
            _maybeScheduleHide() {
        ...
        t.exports = function(t) {
            ...
            e.i = function(t, i, n, s, o) {
                ...
                for (var c = 0; c < t.length; c++) {
                    var h = [].concat(t[c]);
                    n && r[h[0]] || (void 0 !== o && (void 0 === h[5] || (h[1] = "@layer".concat(h[5].length > 0 ? " ".concat(h[5]) : "", " {").concat(h[1], "}")),
                    h[5] = o),
                    i && (h[2] ? (h[1] = "@media ".concat(h[2], " {").concat(h[1], "}"),
                    h[2] = i) : h[2] = i),
                    s && (h[4] ? (h[1] = "@supports (".concat(h[4], ") {").concat(h[1], "}"),
                    h[4] = s) : h[4] = "".concat(s)),
                    e.push(h))
                }
            }
            ...
            return {
                update: function(i) {
                    !function(t, e, i) {
                        ...
                        s && (n += "@layer".concat(i.layer.length > 0 ? " ".concat(i.layer) : "", " {")),
                        n += i.css,
                        s && (n += "}"),
                        i.media && (n += "}"),
                        i.supports && (n += "}");
