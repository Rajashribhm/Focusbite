!function() {
    try {
        ...
        e._sentryDebugIdIdentifier = "sentry-dbid-a6fb5b79-7222-4ec2-abcd-ae3d98ce234d")
    } catch (e) {}
}();
"use strict";
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[2768], {
    44336: function(e, t, a) {
        ...
        var n, i, r, o, s, _, l = a(2366), u = a(96494), E = a(968), d = a(33254), c = a(50726), T = a(30864), p = a(79340);
        let R = async (e, t, a) => (a ??= "com.apple.fps.1_0",
        (await e.build().withMethod("GET").withHost("https://spclient.wg.spotify.com").withPath(`/soundfinder/v1/unauth/episode/${t}/${a}`).withEndpointIdentifier("/unauth/episode/{episodeId}/{keysystem}").send()).body);
        var A = a(23392);
        ...
        i.TOGGLE_REPEAT_CONTEXT_RESTRICTED = "toggle_repeat_context_restricted",
        ...
        i.ONE_TRACK_UNPLAYABLE_AUTO_STOPPED = "one_track_unplayable_auto_stopped",
        i.ALL_TRACKS_UNPLAYABLE_AUTO_STOPPED = "all_tracks_unplayable_auto_stopped",
        i.SKIP_TO_NON_EXISTENT_TRACK_AUTO_STOPPED = "skip_to_non_existent_track_auto_stopped",
        ...
        i.VIDEO_UNSUPPORTED_PLATFORM_VERSION = "video_unsupported_platform_version",
        i.VIDEO_UNSUPPORTED_CLIENT_VERSION = "video_unsupported_client_version",
        ...
        class N extends Error {
            ...
            static getMessage(e, t) {
                ...
                return t.length > 0 ? `Code '${e}' with reasons '${t.join(", ")}'` : void 0 !== a ? `Code '${e}' with cause '${a.name}: ${a.message}'` : `Code '${e}'`
            }
        }
        class S extends N {
            constructor(e, t, a) {
        ...
        let y = {
          ...
          , f = e => e.pages?.length && e.pages[0].items?.length ? e.pages[0].items[0] : e
          , C = function(e) {
            let t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1]
              , a = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : "audio";
            return t ? `@webgate/${y[e]}-license/v1/${a}/license` : `https://spclient.wg.spotify.com/${y[e]}-license/v1/unauth/${a}/license`
        }
          , L = async function(e, t, a) {
            let n = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : "com.widevine.alpha"
            ...
            let E = Error(`No valid solution has been found to play this item (${t?.uri})`);
            throw a.emitSync(m.rg.ERROR, new O(s.ONE_TRACK_UNPLAYABLE,[],E)),
            E
        };
        function P(e) {
            return function() {
        ...
        l.cr)({
          ...
          , k = (e, t) => {
            let a = w(e);
            t.data.entity?.hasVideo && a.on(l.oQ.VIDEO_ELEMENT_APPENDED, () => {
                document.getElementsByTagName("video")[0]?.setAttribute("poster", "data:image/gif;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=")
            }
            );
            let {clientId: n, correlationId: i} = (0,
            d.X)();
            return {
                playerAPI: function(e, t) {
                    ...
                    let n = function(e) {
                        ...
                        return e.on(l.oQ.ERROR, e => {
                            let {error: t} = e.data;
                            t.unrecoverable ? n.emit(m.rg.ERROR, new O(s.PLAYBACK_ERROR,[],t)) : n.emit(m.rg.ERROR, new S(s.PLAYBACK_ERROR,[],t))
                        }
                        ),
                        e.on(l.oQ.PAUSED, _),
                        e.on(l.oQ.PROGRESS, async () => {
                            Date.now() - i.timestamp >= 1e3 && _(),
                            (i.isBuffering || t) && !(await e.getCurrentState()).playbackState.buffering && u(!1)
                        }
                        ),
                        ...
                        e.on(l.oQ.POSITION_CHANGED, async () => {
                            (await e.getCurrentState()).playbackState.playing && await u(!0)
                        }
                        ),
                        n
                    }(e)
                      ...
                      , _ = async () => (void 0 === a && (a = (await e.getMediaConfig()).keysystem),
                    a);
                    return n.addListener(m.rg.UPDATE, e => {
                        let {data: t} = e;
                        i = t
                    }
                    ),
    ...
    50726: function(e, t, a) {
        ...
        var n, i, r, o, s, _, l, u, E, d, c, T, p, R, A = a(968);
        let g = {
            type: A.p.UNKNOWN,
            uri: "",
            uid: "",
        ...
        let I = ["not_playing_track", "not_playing_context", "protocol_limitations", "already_playing", "already_paused", "unknown"];
